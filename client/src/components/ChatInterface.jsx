  ...
  return (
    <div className="flex h-screen bg-gray-100">
        ...
        <Sidebar>
            <SidebarContent>
                <SidebarGroup>
                    <SidebarGroupLabel className="text-3xl text-black mb-3">History</SidebarGroupLabel>
                    <SidebarGroupContent>
                        <SidebarMenu>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="p-4 border-t">
                <form onSubmit={handleSendMessage} className="flex gap-2">
                    <div>
                        <Button type="button" onClick={handleFileInputClick} className="p-2 bg-gray-100 hover:bg-gray-300 rounded cursor-pointer">
